...
install_xcframework "${PODS_ROOT}/FeedMedia/FeedMedia.xcframework" "FeedMedia/Core" "framework" "ios-arm64_armv7" "ios-arm64_x86_64-simulator" "ios-x86_64-maccatalyst"
